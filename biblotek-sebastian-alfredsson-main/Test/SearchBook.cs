...
namespace Libary
{
    class SearchBook
    {
        ...
        {
            string data = File.ReadAllText(@"C:\Users\sebastian.alfredsso\Documents\biblotek-sebastian-alfredsson-main\biblotek-sebastian-alfredsson-main\Test\users.json");
            dynamic usersData = JsonConvert.DeserializeObject<dynamic>(data);
            string data2 = File.ReadAllText(@"C:\Users\sebastian.alfredsso\Documents\biblotek-sebastian-alfredsson-main\biblotek-sebastian-alfredsson-main\Test\books.json");
            ...
            {   
                ...
                File.WriteAllText(@"C:\Users\sebastian.alfredsso\Documents\biblotek-sebastian-alfredsson-main\biblotek-sebastian-alfredsson-main\Test\users.json", dataToSave);
                string dataToSave2 = JsonConvert.SerializeObject(bookData);
                File.WriteAllText(@"C:\Users\sebastian.alfredsso\Documents\biblotek-sebastian-alfredsson-main\biblotek-sebastian-alfredsson-main\Test\books.json", dataToSave2);
                }
                foreach (var book in bookData)
                {
                    if (book.stock == 0 && book.name == "The Hunger Games")
