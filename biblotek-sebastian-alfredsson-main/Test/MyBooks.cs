...
namespace Libary
{
    class MyBooks
    {
        public static void Show()
        {
            ...
            string data2 = File.ReadAllText(@"C:\Users\sebastian.alfredsso\Documents\biblotek-sebastian-alfredsson-main\biblotek-sebastian-alfredsson-main\Test\users.json");
            ...
            foreach (var user in usersData)
            {
                if (user.username == Login.username1)
                {
                    ...
                    if (answer1 == "1")
                    {
                        ...
                        File.WriteAllText(@"C:\Users\sebastian.alfredsso\Documents\biblotek-sebastian-alfredsson-main\biblotek-sebastian-alfredsson-main\Test\books.json", dataToSave);
                        string dataToSave2 = JsonConvert.SerializeObject(bookData);
                        File.WriteAllText(@"C:\Users\sebastian.alfredsso\Documents\biblotek-sebastian-alfredsson-main\biblotek-sebastian-alfredsson-main\Test\users.json", dataToSave2);
