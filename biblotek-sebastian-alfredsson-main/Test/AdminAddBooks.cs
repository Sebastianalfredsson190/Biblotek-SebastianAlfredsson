            ...
            if (answer == "3")
            {
                ...
                foreach (var book in bookData)
                {
                    ...
                    if (answer2 == "3")
                    {
                        ...
                        book.year = answer3;
                        string dataToSave2 = JsonConvert.SerializeObject(bookData);
                        File.WriteAllText(@"C:\Users\sebastian.alfredsso\Documents\biblotek-sebastian-alfredsson-main\biblotek-sebastian-alfredsson-main\Test\books.jsonn", dataToSave2);
                    }
                }
            }
        }
